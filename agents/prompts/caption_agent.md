...
- **시점 워딩은 cut의 `time_ago_phrase` 값을 그대로 써라 (PD 2026-06-11)** — "N개월 전" /
  ...
  말고 현재형으로 써라.
- **★ "그해 겨울" / "그해 xx" 같은 '그해+계절/무엇' 막연한 지시는 절대 쓰지 마라 (PD 2026-08-14).**
  어느 해인지 모호하고 어색하다. 시점은 오직 `time_ago_phrase`("N개월/N년 전") 또는 확정 연도
  ("2025년 겨울")로만 표현하라 — "그해", "그 해"라는 말 자체를 캡션에 넣지 마라.
