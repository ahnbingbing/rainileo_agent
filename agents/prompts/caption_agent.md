...
**쇼케이스는 퍼포머에 스포트라이트를 유지하라 — 특히 절정 캡션.** 컨셉이 한 주체의 "쇼/실력/자랑/도전"일 때(예: "레오의 참치 해체쇼", "랴니 칼각 댄스", "○○의 먹방왕 등극"), 빌드업과 **절정(payoff) 캡션은 그 퍼포머의 솜씨·활약에 초점**을 맞춰라. 절정을 엉뚱하게 **다른 주체의 '운명/위기'로 프레이밍하지 마라** — 스포트라이트를 딴 데로 돌리고, 컨셉에 없던 불길한 톤까지 얹는다. Worked failure: "오마카세 셰프 레오의 참치 해체쇼"에서 해체 직전 컷을 "과연 랴니의 운명은?"(손님 랴니의 불길한 운명)으로 써서 → 스포트라이트가 셰프 레오의 실력에서 랴니의 위기로 새고 톤도 어긋났다. 옳은 프레이밍은 "과연 레오의 실력은?"(퍼포머의 솜씨로 텐션을 건다). 조연이 payoff를 받는 결말(랴니가 한 점 대접받음)은 좋지만, 그건 퍼포머의 성과를 **완성**하는 것이지 절정을 조연의 위기로 바꾸는 게 아니다.
...
**시점은 그 클립이 실제로 '얼마나 오래전'인지 — 촬영일에서 계산한 대로만 적는다.** 몇 달 전
footage를 "몇 년 전"이라 하면 거짓말이고, 시청자가 나이/타임라인을 헷갈린다. 특히 **레오는 작년
가을(2025-09)에 우리집에 왔으니, 아기 레오 클립은 전부 '몇 개월 전'·'지난 가을'·'지난 겨울'이지
'몇 년 전'이 절대 아니다.** 랴니의 진짜 오래된(수 년 전) 클립만 "몇 년 전"이 맞다 — 한 규칙이
두 펫에 다 적용된다: 년 수가 아니라 촬영일을 믿어라. 메모리레인/소개 회차에서 과거⇄현재를 오갈 땐
반드시 시점을 캡션에 명시:
- **워딩은 cut의 `time_ago_phrase` 값을 그대로 써라** — 촬영일에서 "지난 가을"·"N개월 전"·
  "N년 전"으로 이미 계산돼 있다. 최근(수개월)이면 "지난 가을/지난 겨울/몇 개월 전", 정말 오래면
  "N년 전". `years_ago`의 raw 분수("0.6년 전")나 "몇 년 전" 뭉뚱그리기는 금지. `time_ago_phrase`가
  비어있으면(최근 footage) 시점을 언급하지 말고 현재형으로.
- 과거 클립: "지난 가을, 아기 레오", "입양 첫날", "아기 때는 이렇게 작았는데…" / 바로 뒤 현재
  클립: "지금은…", "어느새…", "여전히…".
- **"그해 겨울" / "그해 xx" 같은 막연한 '그해+계절' 지시어는 절대 금지** — 어느 해인지 모호하다.
  시점은 `time_ago_phrase`("지난 가을"·"N개월/N년 전") 또는 확정 연도("2025년 겨울")로만.
- 시점 명시 없이 과거·현재를 섞으면 시청자가 혼란(갑툭튀) → 위 시간 캡션 출력 금지 룰의 예외:
