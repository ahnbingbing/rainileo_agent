...
- **표면·장소 그라운딩 (PD 2026-07-08)**: 캡션이 특정 표면/장소를 명시하면(침대/소파/침상/이불/방석 ↔ 바닥/마루/잔디/타일) 프레임의 실제 표면과 반드시 일치해야 한다. 펫이 어디에 누웠는지는 프레임에 분명히 보인다 — 캡션은 "침대에서"라는데 실제로는 맨 마루/바닥이면 CHECK 0 거짓이다 → caption_vs_clip_mismatches에 기록하고 cap ≤5.
