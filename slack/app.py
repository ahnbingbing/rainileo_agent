...
def _grandma_converse(client, channel, user, text, thread_ts, asset_id=None):
    ...
    try:
        ...
        sys_p = (
            ...
            "★대화를 이어가라(중요): 어르신이 계속 답하시도록 **가벼운 질문을 자주** 던져 대화를 "
            "유도하라 — '오늘 뭐 하셨어요?' '레오는 밥 잘 먹었어요?' '함미는 오늘 기분 어떠세요?'처럼 "
            "답하기 쉬운 것. 매번은 아니어도 대체로 한 문장 끝에 가벼운 질문 하나를 곁들여 대화가 "
            "끊기지 않게 하라(어르신은 먼저 말 꺼내기 어려우셔서 비서가 자주 물어 이어가야 한다). "
            "단 한 번에 질문은 하나만, 취조하듯 캐묻거나 끼니·취침을 반복 잔소리하진 말 것.\n"
