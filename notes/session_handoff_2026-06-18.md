...
- **남은 일**: **6/19를 다시 채워야 함**(현재 1/4). 버그 고쳤으니 `python -m agents.launch --date
  2026-06-19`로 재렌더 가능. ⚠️ **AV는 유료(~$50/편)** — RF만 먼저 채우려면 `--lane real_footage`.
  오늘 밤 03:00 배치는 6/20을 만들지 6/19를 안 고친다.
