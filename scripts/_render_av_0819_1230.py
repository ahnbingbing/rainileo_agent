...
DIRECTIVE = (
    ...
    "막5(윙크): 막내 레오가 시무룩한 랴니를 위로하듯 카메라를 향해 한쪽 눈을 또렷하게 찡긋 윙크 1회 — '비 "
    "그치면 꼭 산책 가자, 랴니야! ☔→☀'. 랴니는 곁에서 그 모습을 본다.\n"
    "★★승자/윙크 = 레오(wink_subject=leo). 레오가 한쪽 눈 분명히 감았다 뜨는 크고 또렷한 윙크(개인 랴니는 "
    "윙크 억지로 시키지 않는다 — 부자연스러워 렌더가 깨진다). 랴니 마킹은 이 컷에서도 앞 컷과 동일하게 유지.\n"
