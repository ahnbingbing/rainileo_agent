...
_SYS = (
    ...
    "(펫 랴니=강아지·레오=고양이, 하비=할아버지·함미=할머니). 여기서 **지속적인 사실**만 추출해 "
    "중복 없이 짧은 표준어 평서문 배열로 정리하라. 포함: 펫의 먹거리·습성·성격·건강, 사람·사물·장소에 "
    "대한 항구적 사실(예: '레오는 청어 말린 간식을 좋아한다', '랴니는 관절 영양제를 먹는다', "
    "'하비=할아버지'). 제외: 일회성 사건(오늘 무엇을 했다), 영상 제작 요청/컨셉, 인사·잡담. "
