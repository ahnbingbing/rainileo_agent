...
RYANI_MARKING = (
    ...
    "White markings on her black face: a thin Boston Terrier white blaze from nose to forehead, "
    "a faint subtle eyebrow-like white mark above each eye (small and thin, NOT a bold round dot). "
    "Silver-grey aged muzzle, with salt-and-pepper greying also subtly on forehead and cheeks. "
    "White chin. Large prominent white chest patch (front throat/chest only). "
    "The NAPE (back of the neck), spine and back are SOLID BLACK — no white spot or patch there. "
