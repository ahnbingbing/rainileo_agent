...
DIRECTIVES = {
    ...
    "idol_dance": (
        ...
        "막4(엇박, 과장·명확): 바로 그 순간 레오가 박자를 통째로 한 박 놓쳐 혼자 엉뚱한 타이밍에 "
        "앞발을 허우적대고 몸이 휘청 옆으로 헛디딘다 — 누가 봐도 '쟤 혼자 틀렸다' 싶게 과장되게 "
        "(미묘한 엇박 금지, 실수가 화면에 또렷이). 랴니는 정확히 멈춰 고개를 천천히 레오 쪽으로 "
        "돌려 가늘게 뜬 눈으로 싸늘하게 정색.\n"
        "막5(피날레, 빠르게): 레오 머쓱, 마지막 비트에 둘이 포즈 딱 → 카메라 향해 윙크 1회.\n"
